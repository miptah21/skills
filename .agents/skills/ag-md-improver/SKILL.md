...
tools: view_file, list_dir, grep_search, run_command, replace_file_content
---

# AGENTS.md Improver

Audit, evaluate, and improve AGENTS.md files across a codebase to ensure Antigravity has optimal project context.
...
| Global defaults | `C:\Users\mifta\.gemini\antigravity\AGENTS.md` | User-wide defaults across all projects |
...
After user approval, apply changes using the replace_file_content tool. Preserve existing content structure.
...
- **`#` key shortcut**: During a session, instruct the agent to auto-incorporate learnings into AGENTS.md
...
- **Global defaults**: Put user-wide preferences in `C:\Users\mifta\.gemini\antigravity\AGENTS.md`
