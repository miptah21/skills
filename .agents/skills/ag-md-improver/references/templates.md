...
Describe the project structure so Antigravity understands where things live.
...
List important files that Antigravity should know about.
...
4. **Be useful**: Would this help a new Antigravity session understand the project?
