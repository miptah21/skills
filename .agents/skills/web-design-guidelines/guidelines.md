...
> Vendored from [vercel-labs/web-interface-guidelines](https://github.com/vercel-labs/web-interface-guidelines).
...
- Use semantic HTML (`<nav>`, `<main>`, `<section>`, `<article>`) before ARIA
