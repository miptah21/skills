...
description: Background knowledge for data engineering architecture and design patterns. Provides general context on data stack, performance targets, and best practices. For specific tasks, use the dedicated skills (creating-dbt-models, authoring-dags, sql-queries, etc.).
